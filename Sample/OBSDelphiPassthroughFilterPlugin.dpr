library OBSDelphiPassthroughFilterPlugin;
...
uses
  ...
  OBSDelphiPassthroughFilterSource in 'OBSDelphiPassthroughFilterSource.pas';
...
begin
  RegisterOBSDelphiPassthroughFilterSource;
  Result:=True;
end;
...
begin
  Result:='OBS Delphi Passthrough Filter';
end;

function obs_module_description: PAnsiChar; cdecl;
begin
  Result:='Minimal OBS video filter for validating Delphi filter-processing bindings.';
end;
