library OBSDelphiGraphicsSmokePlugin;
...
uses
  ...
  OBSDelphiGraphicsSmokeSource in 'OBSDelphiGraphicsSmokeSource.pas';
...
begin
  RegisterOBSDelphiGraphicsSmokeSource;
  Result:=True;
end;
...
begin
  Result:='OBS Delphi Graphics Smoke';
end;

function obs_module_description: PAnsiChar; cdecl;
begin
  Result:='Custom-draw graphics smoke source for validating Delphi gs_* bindings.';
end;
